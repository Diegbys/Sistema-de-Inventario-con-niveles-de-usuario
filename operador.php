...
<head>
    ...
    <title>Visualizar Operador</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="cerrarSesion.php"><i class="fas fa-door-closed"></i>Cerrar</a></li>
        </ul>
    </div>
    <!--END SIDEBAR-->
    ...
    <main>
        ...
        <!--BEGIN TABLE-->
        <table class="content-table" id="tabla"></table>
        <!--END TABLE-->
    </main>
