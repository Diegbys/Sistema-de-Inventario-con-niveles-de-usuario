<?php
    ...
    if ($_POST) {
        ...
        $sql_agregar_ajuste_enc_inventario = 'INSERT INTO ajuste_enc_precio(fecha_At,observacion) VALUES (?,?)';
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
                <a href="#"> <i class="fa fa-cogs" aria-hidden="true"></i>Ajustes</a>
            </li>
    ...
    <main>
        ...
        <ul class="navbar navbar-ajustes">
            <li>
                <a href="ajuste-inventario.php">
                    ...
                    <div class="name"><span data-text="Conceptos">Inventario</span></div>
                </a>
            </li>
            <li>
                <a href="#">
                    ...
                    <div class="name"><span data-text="Marcas">Precio</span></div>
                </a>
            </li>
        </ul>
        <!--END NAVBAR-->
        ...
        <section class="contenedor1 contenedor2">
            <a href="#popup1" style="z-index: 1;">
                ...
                <span></span>
                <span></span>
                <span></span> Realizar Ajuste de Precio
            </a>
        </section>
        <!--EDITAR CONCEPTO-->
    ...
    <div class="container-modal">
        <div class="popup" id="popup1">
            <div class="popup-inner">
                <div class="left"></div>
                <div class="right">
                    <h2>Realizar Ajuste de Precio</h2>
                    <form method="POST" action="ajuste-precio.php">
